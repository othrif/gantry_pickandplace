...
%> @ingroup Modbus
function [returnValue] = A3200ModbusRegisterDoubleReadDrive(handle, taskId, Axis, RegName, RegNumber)
  ...
  [returnValue] = A3200ModbusRegisterDoubleReadDrive_internal(handle, taskId, Axis, RegName, RegNumber);
