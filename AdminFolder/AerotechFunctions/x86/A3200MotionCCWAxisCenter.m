...
%>
%> This command is the same as CCW in AeroBasic.
%>
%> @param handle The handle to the controller on which to execute the command
%> @param taskId The ID of the task on which to execute the command
%> @param Axis1 The first axis on which to do counterclockwise circular motion.
%> @param Axis1Endpoint The end point of the movement on the first specified axis.
%> @param Axis2 The second axis on which to do counterclockwise circular motion.
...
%>
%> @ingroup motion
function A3200MotionCCWAxisCenter(handle, taskId, Axis1, Axis1Endpoint, Axis2, Axis2Endpoint, Axis1Center, Axis2Center, CoordinatedSpeed)
  ...
  A3200MotionCCWAxisCenter_internal(handle, taskId, Axis1, Axis1Endpoint, Axis2, Axis2Endpoint, Axis1Center, Axis2Center, CoordinatedSpeed);
end
