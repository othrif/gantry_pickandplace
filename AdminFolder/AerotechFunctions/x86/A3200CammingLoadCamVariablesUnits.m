...
%>
%> @ingroup camming
function A3200CammingLoadCamVariablesUnits(handle, taskId, MasterAxis, TableNumber, SlaveAxis, InterpolationType, TrackingMode, MasterStart, MasterDelta, VariableStart, VariableNumber, Wrap)
  ...
  Wrap = int32(Wrap);
  A3200CammingLoadCamVariablesUnits_internal(handle, taskId, MasterAxis, TableNumber, SlaveAxis, InterpolationType, TrackingMode, MasterStart, MasterDelta, VariableStart, VariableNumber, Wrap);
end
