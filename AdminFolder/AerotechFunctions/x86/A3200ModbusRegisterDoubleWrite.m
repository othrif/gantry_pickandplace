...
%>
%> @ingroup Modbus
function A3200ModbusRegisterDoubleWrite(handle, taskId, ConnectionNumber, RegName, RegNumber, Value)
  ...
  Value = double(Value);
  A3200ModbusRegisterDoubleWrite_internal(handle, taskId, ConnectionNumber, RegName, RegNumber, Value);
end
