...
%> @ingroup Modbus
function [returnValue] = A3200ModbusRegisterInt16Read(handle, taskId, ConnectionNumber, RegName, RegNumber)
  ...
  [returnValue] = A3200ModbusRegisterInt16Read_internal(handle, taskId, ConnectionNumber, RegName, RegNumber);
