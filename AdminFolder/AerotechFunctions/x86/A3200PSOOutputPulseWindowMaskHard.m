...
%>
%> @ingroup pso
function A3200PSOOutputPulseWindowMaskHard(handle, taskId, Axis, OutputSelect, EdgeMode)
  ...
  A3200PSOOutputPulseWindowMaskHard_internal(handle, taskId, Axis, OutputSelect, EdgeMode);
end
