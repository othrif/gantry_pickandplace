...
%>
%> @ingroup Modbus
function A3200ModbusRegisterInt32WriteDrive(handle, taskId, Axis, RegName, RegNumber, Value)
  ...
  Value = int32(Value);
  A3200ModbusRegisterInt32WriteDrive_internal(handle, taskId, Axis, RegName, RegNumber, Value);
end
