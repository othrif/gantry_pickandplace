...
%>
%> This command is the same as PSOOUTPUT PULSE in AeroBasic.
%>
...
%>
%> @ingroup pso
function A3200PSOOutputPulse(handle, taskId, Axis, OutputSelect)
  nargoutchk(0, 0, nargout, 'struct');
  handle = uint64(handle);
  taskId = int32(taskId);
  Axis = int32(Axis);
  OutputSelect = int32(OutputSelect);
  A3200PSOOutputPulse_internal(handle, taskId, Axis, OutputSelect);
end
