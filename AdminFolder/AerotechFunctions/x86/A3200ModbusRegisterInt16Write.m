...
%>
%> @ingroup Modbus
function A3200ModbusRegisterInt16Write(handle, taskId, ConnectionNumber, RegName, RegNumber, Value)
  ...
  Value = int32(Value);
  A3200ModbusRegisterInt16Write_internal(handle, taskId, ConnectionNumber, RegName, RegNumber, Value);
end
