...
%>
%> @ingroup Modbus
function A3200ModbusRegisterFloatWriteDrive(handle, taskId, Axis, RegName, RegNumber, Value)
  ...
  Value = float(Value);
  A3200ModbusRegisterFloatWriteDrive_internal(handle, taskId, Axis, RegName, RegNumber, Value);
end
