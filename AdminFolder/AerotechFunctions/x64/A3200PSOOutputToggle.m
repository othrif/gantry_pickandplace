...
%>
%> This command is the same as PSOOUTPUT TOGGLE in AeroBasic.
%>
...
%>
%> @ingroup pso
function A3200PSOOutputToggle(handle, taskId, Axis, OutputSelect)
  nargoutchk(0, 0, nargout, 'struct');
  handle = uint64(handle);
  taskId = int32(taskId);
  Axis = int32(Axis);
  OutputSelect = int32(OutputSelect);
  A3200PSOOutputToggle_internal(handle, taskId, Axis, OutputSelect);
end
