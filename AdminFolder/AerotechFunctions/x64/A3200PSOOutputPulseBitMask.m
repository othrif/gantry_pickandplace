...
%>
%> This command is the same as PSOOUTPUT PULSE BIT MASK in AeroBasic.
%>
...
%>
%> @ingroup pso
function A3200PSOOutputPulseBitMask(handle, taskId, Axis, OutputSelect, StartIndex, NumElements)
  ...
  A3200PSOOutputPulseBitMask_internal(handle, taskId, Axis, OutputSelect, StartIndex, NumElements);
end
