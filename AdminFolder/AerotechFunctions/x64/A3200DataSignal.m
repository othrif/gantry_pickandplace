%> @brief Contains values for datacollection item numbers.
classdef A3200DataSignal < int32
  enumeration
...
%> @brief Analog Input 1 signal.
    AnalogInput1 (11)
%> @brief Phase A Current Feedback signal.
    PhaseACurrentFeedback (24)
%> @brief Phase B Current Feedback signal.
    PhaseBCurrentFeedback (25)
%> @brief Encoder Sine signal.
    EncoderSine (26)
%> @brief Encoder Cosine signal.
    EncoderCosine (27)
...
%> @brief Analog Output 3 signal.
    AnalogOutput3 (39)
%> @brief PSO Status signal.
    PSOStatus (43)
%> @brief Drive Timer signal.
    DriveTimer (44)
%> @brief PSO Counter 1 signal.
    PSOCounter1 (229)
%> @brief PSO Counter 2 signal.
    PSOCounter2 (230)
%> @brief PSO Counter 3 signal.
    PSOCounter3 (231)
%> @brief PSO Window 1 signal.
    PSOWindow1 (232)
%> @brief PSO Window 2 signal.
    PSOWindow2 (233)
%> @brief Data Acquisition Samples signal.
    DataAcquisitionSamples (234)
%> @brief Position Detector Voltage signal.
    PositionDetectorVoltage (235)
%> @brief Position Command Galvo signal.
    PositionCommandGalvo (237)
%> @brief Resolver Channel 1 signal.
    ResolverChannel1 (267)
%> @brief Resolver Channel 2 signal.
    ResolverChannel2 (268)
%> @brief EnDat Absolute Position signal.
    EnDatAbsolutePosition (269)
%> @brief ModbusBit MasterInputBits signal.
    ModbusBitMasterInputBits (290)
%> @brief ModbusBit MasterOutputBits signal.
    ModbusBitMasterOutputBits (291)
%> @brief ModbusRegInt16 MasterInputWords signal.
    ModbusRegInt16MasterInputWords (292)
%> @brief ModbusRegInt16 MasterOutputWords signal.
    ModbusRegInt16MasterOutputWords (293)
%> @brief ModbusRegInt32 MasterInputWords signal.
    ModbusRegInt32MasterInputWords (294)
%> @brief ModbusRegInt32 MasterOutputWords signal.
    ModbusRegInt32MasterOutputWords (295)
%> @brief ModbusRegSingle MasterInputWords signal.
    ModbusRegSingleMasterInputWords (296)
%> @brief ModbusRegSingle MasterOutputWords signal.
    ModbusRegSingleMasterOutputWords (297)
%> @brief ModbusRegDouble MasterInputWords signal.
    ModbusRegDoubleMasterInputWords (298)
%> @brief ModbusRegDouble MasterOutputWords signal.
    ModbusRegDoubleMasterOutputWords (299)
%> @brief Amplifier Peak Current signal.
    AmplifierPeakCurrent (303)
%> @brief Drive Type ID signal.
    DriveTypeID (305)
%> @brief PSO Window 1 Array Index signal.
    PSOWindow1ArrayIndex (306)
%> @brief PSO Window 2 Array Index signal.
    PSOWindow2ArrayIndex (307)
%> @brief PSO Distance Array Index signal.
    PSODistanceArrayIndex (308)
%> @brief Amplifier Temperature signal.
    AmplifierTemperature (309)
%> @brief PSO Bit Array Index signal.
    PSOBitArrayIndex (310)
%> @brief MX Absolute Position signal.
    MXAbsolutePosition (311)
%> @brief Servo Update Rate signal.
    ServoUpdateRate (312)
%> @brief Settling Time signal.
    SettlingTime (313)
%> @brief Drive Timer Max signal.
    DriveTimerMax (319)
%> @brief Marker Search Distance signal.
    MarkerSearchDistance (320)
%> @brief Position Feedback Galvo signal.
    PositionFeedbackGalvo (327)
%> @brief Latched Marker Position signal.
    LatchedMarkerPosition (331)
%> @brief Temperature Sensor signal.
    TemperatureSensor (332)
%> @brief Resolute Absolute Position signal.
    ResoluteAbsolutePosition (369)
%> @brief Fault Position Feedback signal.
...
%> @brief Time Since Reset signal.
    TimeSinceReset (387)
%> @brief Galvo Laser Output signal.
    GalvoLaserOutput (409)
%> @brief Galvo Laser Power Correction Output signal.
    GalvoLaserPowerCorrectionOutput (414)
%> @brief Capacitance Sensor Raw Position signal.
    CapacitanceSensorRawPosition (415)
%> @brief Position Calibration Galvo signal.
    PositionCalibrationGalvo (419)
%> @brief Analog Sensor Input signal.
    AnalogSensorInput (446)
%> @brief Motor Temperature signal.
...
%> @brief Position Error Galvo signal.
