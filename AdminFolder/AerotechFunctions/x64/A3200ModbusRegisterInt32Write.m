...
%>
%> @ingroup Modbus
function A3200ModbusRegisterInt32Write(handle, taskId, ConnectionNumber, RegName, RegNumber, Value)
  ...
  Value = int32(Value);
  A3200ModbusRegisterInt32Write_internal(handle, taskId, ConnectionNumber, RegName, RegNumber, Value);
end
