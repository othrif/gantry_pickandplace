...
%> @param Source3 The encoder to use as the source for the third axis of tracking (DO NOT use for single-axis).
%>
%> @ingroup pso
function A3200PSOTrackInputInput2Input3(handle, taskId, Axis, Source1, Source2, Source3)
  ...
  Source3 = int32(Source3);
  A3200PSOTrackInputInput2Input3_internal(handle, taskId, Axis, Source1, Source2, Source3);
end
