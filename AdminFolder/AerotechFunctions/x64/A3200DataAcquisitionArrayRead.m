...
%>
%> @ingroup dataacq
function A3200DataAcquisitionArrayRead(handle, taskId, Axis, ControllerVariable, StartIndex, NumberOfElements)
  ...
  A3200DataAcquisitionArrayRead_internal(handle, taskId, Axis, ControllerVariable, StartIndex, NumberOfElements);
end
