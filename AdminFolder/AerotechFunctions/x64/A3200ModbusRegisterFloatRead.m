...
%> @ingroup Modbus
function [returnValue] = A3200ModbusRegisterFloatRead(handle, taskId, ConnectionNumber, RegName, RegNumber)
  ...
  [returnValue] = A3200ModbusRegisterFloatRead_internal(handle, taskId, ConnectionNumber, RegName, RegNumber);
