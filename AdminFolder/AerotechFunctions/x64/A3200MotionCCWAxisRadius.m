...
%>
%> @ingroup motion
function A3200MotionCCWAxisRadius(handle, taskId, Axis1, Axis1Endpoint, Axis2, Axis2Endpoint, Radius, CoordinatedSpeed)
  ...
  A3200MotionCCWAxisRadius_internal(handle, taskId, Axis1, Axis1Endpoint, Axis2, Axis2Endpoint, Radius, CoordinatedSpeed);
end
