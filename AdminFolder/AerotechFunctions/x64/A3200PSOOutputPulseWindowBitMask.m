...
%>
%> This command is the same as PSOOUTPUT PULSE WINDOW BIT MASK in AeroBasic.
%>
...
%>
%> @ingroup pso
function A3200PSOOutputPulseWindowBitMask(handle, taskId, Axis, StartIndex, NumElements, EdgeMode)
  ...
  A3200PSOOutputPulseWindowBitMask_internal(handle, taskId, Axis, StartIndex, NumElements, EdgeMode);
end
