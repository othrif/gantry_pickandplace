...
%> @param MinVoltage Specifies the minimum voltage for the analog output.
%> @param MaxVoltage Specifies the maximum voltage for the analog output.
%>
%> @ingroup analog
function A3200AdvancedAnalogTrackLimit(handle, taskId, Axis, AnalogOutput, ServoValue, ScaleFactor, OffsetValue, MinVoltage, MaxVoltage)
  ...
  MinVoltage = double(MinVoltage);
  MaxVoltage = double(MaxVoltage);
  A3200AdvancedAnalogTrackLimit_internal(handle, taskId, Axis, AnalogOutput, ServoValue, ScaleFactor, OffsetValue, MinVoltage, MaxVoltage);
end
