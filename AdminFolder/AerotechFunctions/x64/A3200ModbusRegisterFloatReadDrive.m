...
%> @ingroup Modbus
function [returnValue] = A3200ModbusRegisterFloatReadDrive(handle, taskId, Axis, RegName, RegNumber)
  ...
  [returnValue] = A3200ModbusRegisterFloatReadDrive_internal(handle, taskId, Axis, RegName, RegNumber);
